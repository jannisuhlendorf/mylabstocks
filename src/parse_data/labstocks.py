...
class Strains(BaseModel):
    ...
    last_modified = DateField(db_column='Last_modified', null=True)
    ...
    locus4 = CharField(null=True)
    locus5 = CharField(null=True)
    original_no = IntegerField(null=True)
    relevant_oligos = TextField(null=True)
    relevant_plasmids = TextField(null=True)
    species = CharField()
    storage_fridges = CharField(null=True)
    storage_minus20freezers = CharField(null=True)
    storage_minus80freezers = CharField(null=True)
