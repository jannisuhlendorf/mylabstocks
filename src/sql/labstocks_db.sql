...
CREATE TABLE `strains` (
  ...
  `Comments` longtext,
  `General_Background` varchar(500) NOT NULL,
  `Mating_Type` varchar(50) DEFAULT NULL,
  `Plasmid` int(10) unsigned DEFAULT NULL,
  `ADE2` varchar(100) DEFAULT NULL,
  `HIS3` varchar(100) DEFAULT NULL,
  `LEU2` varchar(100) DEFAULT NULL,
  `LYS2` varchar(100) DEFAULT NULL,
  `TRP1` varchar(100) DEFAULT NULL,
  `URA3` varchar(100) DEFAULT NULL,
  `HO_` varchar(100) DEFAULT NULL,
  `locus1` varchar(100) DEFAULT NULL,
  `locus2` varchar(100) DEFAULT NULL,
  `locus3` varchar(100) DEFAULT NULL,
  ...
  `Reference_` varchar(500) DEFAULT NULL,
  `locus4` varchar(100) DEFAULT NULL,
  `locus5` varchar(100) DEFAULT NULL,
  `Cytoplasmic_Character` varchar(250) DEFAULT NULL,
  `Last_modified` date DEFAULT NULL,
  `MET15` varchar(100) DEFAULT NULL,
  `Author` varchar(50) DEFAULT NULL,
  `storage_minus20freezers` varchar(100) DEFAULT NULL,
  `storage_minus80freezers` varchar(100) DEFAULT NULL,
